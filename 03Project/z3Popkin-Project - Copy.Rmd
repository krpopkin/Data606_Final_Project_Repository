...
The 52% correlation is strong, but not as strong as expected.  What's surprising to me is that average pay is showing a lower correlation than education in the previous heatmap.

<B> Home Values and Wages Colored by Census Region </B>   
There are 2,745 counties across 50 states, but only 4 census regions. We'll use regions to create several visual representations of the relationships between education, wages, resident count, and home values. 
