...
<I> Join files </I>
Now we'll join the education, wages, and housing dataframes using county as the key.  This will give us a single data file to complete the project with.
```{r}
masterdata <- sqldf('select * 
                    from education
                    inner join wages on education.county = wages.county')
